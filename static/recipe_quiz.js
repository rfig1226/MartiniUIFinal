$(document).ready(function(){
    ...
    function fetchRecipeData(recipe_id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                correctOrder = Object.values(recipeData.steps).map(step => step.step_title.substring(8));
    ...
    function updatePage(recipeData) {
        ...
        stepIds.forEach(function(stepId, index) {
            ...
            var stepHtml = "<li id='step-" + index + "' class='ui-state-default' style='padding: 10px;'>" + shortenedTitle + "</li>";
    ...
    $("#reset").click(function() {
        ...
        $("#reset").hide(); // Hide the reset button again
    });
    ...
    function calculateScore(correctOrder) {
        ...
        for (var i = 0; i < currentOrder.length; i++) {
            ...
            console.log("current step: " + currentStepTitle + "vs. correct step: " + correctStepTitle);
            ...
            if (currentStepTitle === correctStepTitle) {
                ...
                $("#" + currentStepId).after("<li style='color: red;'>Correct step: " + correctStepTitle + "</li>");
            }
        }
        return score;
    }
    ...
    function displayResult(score) {
        $("#result").text("Results: " + score + "/" + correctOrder.length);
    }
